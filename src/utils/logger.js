/**
 * Utility: in-browser structured logger.
 *
 * Singleton with log(level, context, message, data).
 * Appends timestamped entries to an in-memory circular buffer (last 200).
 * Mirrors to console at matching level.
 * Exposed on window.__dspLogger for DevTools access.
 */
...
class Logger {
   ...
   * @param {string} context  Module/component name, e.g. 'app', 'router'
